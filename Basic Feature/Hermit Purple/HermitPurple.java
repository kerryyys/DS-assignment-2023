...
public int StartMenu() throws ClassNotFoundException{
    ...
    //     HermitPurple hermitPurple = DataStorage.loadState();
    //     if (hermitPurple != null) {
    //         // Restore the state
    //         this.currentLocation = hermitPurple.currentLocation;
    //         this.visitedLocation = hermitPurple.visitedLocation;
    //         this.temp = hermitPurple.temp;
    //         this.previousLocation = hermitPurple.previousLocation;
    //         this.missionMap = hermitPurple.missionMap;
    //         this.adjacentVertices = hermitPurple.adjacentVertices;
    //     }
    // }
